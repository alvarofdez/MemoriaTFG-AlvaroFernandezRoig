...
El módulo de torneos de Dr. Scratch se ha desarrollado utilizando Django, un framework en lenguaje Python. Se ha utilizado una base de datos PostgreSQL, y para el diseño de las pantallas se ha utilizado el framework Bootstrap. 
...
Finalmente en octubre de 2019 retomé, esta vez con plena dedicación, el desarrollo de la aplicación. De lo realizado en 2017 salvé parte del modelo pero comencé a realizar todo de nuevo, es por esto que el comienzo de la planificación es el 1 de octubre de 2019.
 ...
 \begin{figure}[H]
		\centering
	 \includegraphics[width=12cm, keepaspectratio]{img/planificacion}
...
A continuación se detalla el módulo de torneos de Dr. Scratch, incuyendo su arquitectura y su modelo de datos.
